...
var budgetController = (function (){
    ...
    return {
        addItem: function(type, des , val){
            var newItem, ID;
            //ID = last element + 1 , last element is length - 1
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var ctrlAddItem = function(){
        var input, newItem;
        /*
        when someone clicks the button. we need the following to happen
        ...
        if(input.description !== ""  && !isNaN(input.value) && input.value > 0 ){
            ...
            //5.calculate and update budget
                updateBudget();
            //6.update and calcuate percentages
                updatePercentages();
    ...
    var ctrlDeleteItem = function(event){
        ...
        if(itemID){
            ...
            updateBudget();
            //4.update and calcuate percentages
                updatePercentages();
        }
    };
